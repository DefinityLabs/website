      ...
      <Page>
        <Title>
          <div className="container">
            <h1>
              Products <small>are free to use & contribute</small>
            </h1>
          </div>
        </Title>
        <Container>
          <Section>
            <Card>
              <h2>
                {emoji.get('rocket')} <Link to="/products/aux4">aux4</Link>
              </h2>
            ...
            <Card>
              <h2>
                {emoji.get('cherries')}{' '}
                <Link to="/products/cherry-pick-tool">Cherry Pick Tool</Link>
              </h2>
